...
COM3 
tpfinalparte1
Sofia Brizuela 118977/0 
Ada Rojas
link: https://youtu.be/YZmplB8Vndw
*/
...
function setup() {
  ...
  inicializar();
  sonidoMusica = document.getElementById("bosque");
}
